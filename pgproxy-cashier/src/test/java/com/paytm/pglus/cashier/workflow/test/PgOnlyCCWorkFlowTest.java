 ...
 *
 */
public class PgOnlyCCWorkFlowTest extends BaseWorkFlowTest {

    /*
     * @Test(expected = CashierCheckedException.class) public void
     * testNullRequest() throws CashierCheckedException,
     * PaytmValidationException {
     * GenericCoreResponseBean<InitiatePaymentResponse> response =
     * paymentServiceImpl.initiate(null); String message =
    ...
    public void testValidRequestPgOnly() throws PaytmValidationException {
        try {
            ...
            PayBillOptionsBuilder payBillOptionsBuillder = new PayBillOptionsBuilder(100L, 0L, payOptions)
                    .setSaveChannelInfoAfterPay(false);
            ...
            BankCardRequest bankCardRequest = new BankCardRequest("5566204900063606", "123", "2019", "12", "VISA");
            CardRequest cardRequest = new CardRequest("12345", bankCardRequest);

            CashierRequestBuilder cashierRequestBuilder = new CashierRequestBuilder("213123123123123213",
                    RequestIdGenerator.generateRequestId(), CashierWorkflow.ISOCARD)
                    .setPaymentRequest(paymentRequestBuilder.build()).setCardRequest(cardRequest)
                    .setCashierMerchant(cashierMerchant);
