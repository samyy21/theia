...
public class HybridATMAddNPayWorkFlowTest extends BaseWorkFlowTest {

    @Test
    public void testValidRequestHybridATM() throws PaytmValidationException {
        try {
            ...
            PayBillOptionsBuilder payBillOptionsBuillder = new PayBillOptionsBuilder(100L, 0L, payOptions)
                    ...
                    .setPayerAccountNumber("20070000000000002280").setTopAndPay(true).setChannelInfo(channelInfo)
            ...
            PaymentRequestBuilder paymentRequestBuilder = new PaymentRequestBuilder(PaymentType.ADDNPAY,
                    "20160414111212800110166282900000663", TransType.ACQUIRING, requestId,
