...
/**
 * 
 * @author surendra.yadav,Amit.Dubey
 *
 */
public class PgOnlyDCWorkFlowTest extends BaseWorkFlowTest {
    ...
    public void testValidRequestPgOnly() throws PaytmValidationException {
        try {
            ...
            extendInfo.put("merchantTransId", "order_id_nair52");
            ...
            PayBillOptionsBuilder payBillOptionsBuillder = new PayBillOptionsBuilder(100L, 0L, payOptions)
                    .setSaveChannelInfoAfterPay(false).setExtendInfo(extendInfo).setChannelInfo(channelInfo);
            ...
            PaymentRequestBuilder paymentRequestBuilder = new PaymentRequestBuilder(PaymentType.ONLY_PG,
                    "20160415111212800110166281600002273", TransType.ACQUIRING, requestId,
            ...
            CardRequest cardRequest = new CardRequest("556620", bankCardRequest);
