 ...
 *
 */
public class HybridCODWorkFlowTest extends BaseWorkFlowTest {

    @Test
    public void testHybridCODValidRequest() throws PaytmValidationException {
        try {
            ...
            extendInfo.put("merchantTransId", "order_id_nair37");
            ...
            PayBillOptionsBuilder payBillOptionsBuillder = new PayBillOptionsBuilder(301L, 0L, payOptions)
                    .setPayerAccountNumber("20070000000000002280").setWalletBalance(100L).setTopAndPay(false)
            ...
            PaymentRequestBuilder paymentRequestBuilder = new PaymentRequestBuilder(PaymentType.HYBRID_COD,
                    "20160407111212800110166284800000026", TransType.ACQUIRING, requestId,
            ...
            CashierRequestBuilder cashierRequestBuilder = new CashierRequestBuilder("213123123123123213",
                    RequestIdGenerator.generateRequestId(), CashierWorkflow.COD).setCashierMerchant(cashierMerchant);
