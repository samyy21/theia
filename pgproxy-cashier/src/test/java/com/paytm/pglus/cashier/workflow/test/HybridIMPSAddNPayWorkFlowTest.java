 ...
 *
 */
public class HybridIMPSAddNPayWorkFlowTest extends BaseWorkFlowTest {

    @Test
    public void testValidRequestHybridIMPS() throws PaytmValidationException {
        try {
            ...
            PayBillOptionsBuilder payBillOptionsBuillder = new PayBillOptionsBuilder(100L, 0L, payOptions)
                    .setWalletBalance(50L).setPayerAccountNumber("20070000000000002280").setChannelInfo(channelInfo)
            ...
            PaymentRequestBuilder paymentRequestBuilder = new PaymentRequestBuilder(PaymentType.ADDNPAY,
                    "20160414111212800110166283300000701", TransType.TOP_UP, requestId, payBillOptionsBuillder.build(),
                    cashierEnvInfo);
            ...
            CashierRequestBuilder cashierRequestBuilder = new CashierRequestBuilder("213123123123123213",
                    RequestIdGenerator.generateRequestId(), CashierWorkflow.IMPS);
