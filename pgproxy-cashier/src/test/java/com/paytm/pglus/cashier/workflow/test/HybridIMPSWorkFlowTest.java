 ...
 *
 */
public class HybridIMPSWorkFlowTest extends BaseWorkFlowTest {
    ...
    public void testValidRequestHybridIMPS() throws PaytmValidationException {
        try {
            ...
            extendInfo.put("merchantTransId", "order_id_nair50");
            ...
            PaymentRequestBuilder paymentRequestBuilder = new PaymentRequestBuilder(PaymentType.HYBRID,
                    "20160414111212800110166283800000749", TransType.ACQUIRING, requestId,
