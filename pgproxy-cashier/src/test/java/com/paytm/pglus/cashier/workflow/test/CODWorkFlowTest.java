 ...
 *
 */
public class CODWorkFlowTest extends BaseWorkFlowTest {

    @Test
    public void testOnlyCODValidRequest() throws PaytmValidationException {
        try {
            ...
            PayBillOptionsBuilder payBillOptionsBuillder = new PayBillOptionsBuilder(100L, 0L, payOptions)
                    .setTopAndPay(false).setSaveChannelInfoAfterPay(false).setChannelInfo(channelInfo)
            ...
            PaymentRequestBuilder paymentRequestBuilder = new PaymentRequestBuilder(PaymentType.ONLY_COD,
                    "20160414111212800110166285700000698", TransType.ACQUIRING, requestId,
