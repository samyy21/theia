 ...
 *
 */
public class AddMoneyNetBankingWorkflowTest extends BaseWorkFlowTest {
    ...
    public void testValidRequestHybridNetBanking() throws PaytmValidationException {
        try {
            ...
            PaymentRequestBuilder paymentRequestBuilder = new PaymentRequestBuilder(PaymentType.ONLY_PG,
                    "2016041410121481010100166282900001037", TransType.TOP_UP, requestId,
            ...
            CashierRequestBuilder cashierRequestBuilder = new CashierRequestBuilder("213123123123123213",
                    RequestIdGenerator.generateRequestId(), CashierWorkflow.ADD_MONEY_NB).setPaymentRequest(
