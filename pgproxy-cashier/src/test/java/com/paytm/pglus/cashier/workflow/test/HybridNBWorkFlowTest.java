 ...
 *
 */
public class HybridNBWorkFlowTest extends BaseWorkFlowTest {

    @Test
    public void testValidRequestHybridNetBanking() throws PaytmValidationException {
        try {
            ...
            PayBillOptionsBuilder payBillOptionsBuillder = new PayBillOptionsBuilder(100L, 0L, payOptions)
                    .setSaveChannelInfoAfterPay(false).setWalletBalance(10L)
                    .setPayerAccountNumber("20070000000000002280").setChannelInfo(channelInfo)
            ...
            CashierRequestBuilder cashierRequestBuilder = new CashierRequestBuilder("213123123123123213",
                    RequestIdGenerator.generateRequestId(), CashierWorkflow.NB).setPaymentRequest(
