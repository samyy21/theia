 ...
 */
public class IMPSWorkFlowTest extends BaseWorkFlowTest {

    @Test()
    public void testNullRequest() throws PaytmValidationException {
    ...
    public void testValidRequest() throws PaytmValidationException {
        try {
            ...
            extendInfo.put("merchantTransId", "order_id_3");
            ...
            PaymentRequestBuilder paymentRequestBuilder = new PaymentRequestBuilder(PaymentType.ONLY_PG,
                    "20160416111212800110166281400002327", TransType.ACQUIRING, requestId,
    ...
    @Test
    public void testInValidRequest() throws PaytmValidationException {
        try {
            String requestId = RequestIdGenerator.generateRequestId();
            ...
            PayBillOptionsBuilder payBillOptionsBuillder = new PayBillOptionsBuilder(100L, 1L, payOptions);
            ...
            PaymentRequestBuilder paymentRequestBuilder = new PaymentRequestBuilder(PaymentType.ONLY_PG,
                    "20160406111212800110166288500000014", TransType.SEND_MONEY, requestId,
