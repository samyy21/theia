package com.paytm.pgplus.cashier.redis.impl;
...
@Service("pgProxyCashierTransactionalRedisUtil")
public class PgProxyCashierTransactionalRedisUtil implements IPgProxyCashierTransactionalRedisUtil {
