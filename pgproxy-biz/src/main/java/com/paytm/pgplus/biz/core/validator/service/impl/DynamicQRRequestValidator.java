...
@Service("dynamicQrValidator")
public class DynamicQRRequestValidator implements IValidator {

    public static final Logger LOGGER = LoggerFactory.getLogger(DynamicQRRequestValidator.class);
