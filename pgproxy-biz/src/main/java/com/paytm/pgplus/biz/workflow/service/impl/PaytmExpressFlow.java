...
@Service("paytmExpressFlow")
public class PaytmExpressFlow implements IWorkFlow {
    public static final Logger LOGGER = LoggerFactory.getLogger(PaytmExpressFlow.class);
    ...
    public GenericCoreResponseBean<WorkFlowResponseBean> process(WorkFlowRequestBean flowRequestBean) {
         ...
         */
        LOGGER.info("COP from PaytmExpressFlow");
        ...
        LOGGER.info("Returning Response Bean From {}, trans Id : {} ", "PaytmExpressFlow",
