...
@Service("invoicePaymentPostValidator")
public class InvoicePaymentPostRequestValidator implements IValidator {
    public static final Logger LOGGER = LoggerFactory.getLogger(InvoicePaymentPostRequestValidator.class);
