...
@Service("dynamicQrPreScanRequestValidator")
public class DynamicQRPreScanRequestValidator implements IValidator {
    public static final Logger LOGGER = LoggerFactory.getLogger(DynamicQRPreScanRequestValidator.class);
