...
public class EdcLinkEmiSubventionDetailData implements Serializable {

    private static final long serialVersionUID = -6825593836611060593L;
    ...
    public String toString() {
        return "EdcLinkEmiSubventionDetailData{" + "status='" + status + '\'' + ", bankId='" + bankId + '\''
                + ", bankName='" + bankName + '\'' + ", bankCode='" + bankCode + '\'' + ", cardType='" + cardType
                + '\'' + ", bankLogoUrl='" + bankLogoUrl + '\'' + ", planId='" + planId + '\'' + ", pgPlanId='"
                + pgPlanId + '\'' + ", rate='" + rate + '\'' + ", interval='" + interval + '\'' + ", emi='" + emi
                + '\'' + ", interest='" + interest + '\'' + ", emiLabel='" + emiLabel + '\'' + ", message='" + message
                + '\'' + ", emiType='" + emiType + '\'' + ", gratifications=" + gratifications + ", itemBreakUp="
                + itemBreakUp + '}';
    }
}
