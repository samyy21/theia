...
@Service("getSavedTokenizedCardsForAddNPayTask")
public class GetSavedTokenizedCardsForAddNPayTask extends
        AbstractTask<WorkFlowRequestBean, WorkFlowTransactionBean, WorkFlowResponseBean> {

    private static final Logger LOGGER = LoggerFactory.getLogger(GetSavedTokenizedCardsForAddNPayTask.class);
    ...
    public boolean isRunnable(WorkFlowRequestBean requestBean, WorkFlowTransactionBean transBean) {
        ...
        Boolean addNpayEnabled = Boolean.FALSE;
    ...
    public TaskName getTaskName() {
        return TaskName.ADDNPAY_GET_TOKENIZED_CARDS;
    }
