 ...
 * @since 18/09/17
 **/
@Service("linkBasedPaymentValidator")
public class LinkBasedPaymentValidator implements IValidator {

    public static final Logger LOGGER = LoggerFactory.getLogger(LinkBasedPaymentValidator.class);
