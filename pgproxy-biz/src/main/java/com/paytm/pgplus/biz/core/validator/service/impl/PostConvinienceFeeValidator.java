...
@Service("postConvinienceFeeValidator")
public class PostConvinienceFeeValidator implements IValidator {
    public static final Logger LOGGER = LoggerFactory.getLogger(PostConvinienceFeeValidator.class);
