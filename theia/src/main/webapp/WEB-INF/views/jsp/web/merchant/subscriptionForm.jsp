...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<c:if test="${loginInfo.loginWithOtp eq true}">
		...
		<div class="container">
					...
					<div id="merchant-logo" class="fl mt10 mr20 mb20">
						<c:choose>
							<c:when test="${merchInfo.useNewImagePath eq true}">
								<img src="${merchInfo.merchantImage}" alt="" height="20"/>
							</c:when>
							<c:otherwise>
			...
			<c:if test="${not empty onlyWalletEnabled && !onlyWalletEnabled && (txnInfo.subscriptionPaymentMode eq 'CC' || txnInfo.subscriptionPaymentMode eq 'DC' )}">
