...
<div class="large">
	<h2 class="mt10">
		<span class="addMoneyText hide msg">
			<span class="medium">
				<%-- <b class="fr mr20 ml10 hide" id="addMoneyAmtBox"><span class="${CURRENCY_CLASS}">${CURRENCY_TXT}</span> <span class="addMoneyAmount b">${txnInfo.txnAmount}</span></b> --%>
				...
				<c:choose>
				      ...
				      <c:otherwise>
						  <span class="add-msg">Choose another option to complete the payment</span>
