			...
			<c:forEach var="i" begin="1" end="2">
				...
				<div class="emi-bank-map emi-bank-map-${i} ${i eq 2 ? ' hide' : ''}">
					...
					<c:if test="${emiAvailable}">
						...
						<select class="emiBankSelect fl mr10 ${!empty emiSelectedBank ? 'selected' : '' }" >
						...
						<div id="emiConveFeeMsg" class="notification alert fl hide" style="padding: 4px;font-weight: 400; border:none; color: #222; font-size: 12px; margin-top: 0px; padding-left: 10px;padding-right: 10px; background:#f9ffcf;">Taxes extra, as per bank terms and conditions.</div>
			...
			<div class="card-details-wrapper mt20 hide">
				<ul class="grid">
		            ...
		            <li class="fl expiry-wrapper">
		     	    	<label class="mb10 ml10 ccExpMonth ccExpYear" for = "ccExpMonth">EXPIRY DATE</label>
		               	<div class="mb10">
		               		...
		               		<c:if test="${'13' eq paymentType && errorsPresent  && !empty requestScope.validationErrors['INVALID_CARD_EXPIRY']}">
		               	 	...
		               	 	<div class="fl ml10" id = "ccExpMonthWrapper">
				...
				<c:if test="${saveCardOption}">
			        ...
			        <div id = "ccStoreCardWrapper" class="fl mt6">
				...
				<div class="mt20">
					<div class="btn-submit ${submitBtnClass} fl">
						<button name="" type="submit" class="gry-btn btn-normal btn-submit" id = "emiSubmit"  data-txnmode="EMI" onclick="pushGAData(this, 'pay_now_clicked')">${submitBtnText}</button>
