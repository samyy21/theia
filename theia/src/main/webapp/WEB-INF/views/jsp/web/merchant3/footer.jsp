...
<div id="footer" class="mt50">
	...
	<div class="fl small"><span class="fl">Powered By </span> <img src="${ptm:stResPath()}images/web/merchant3/paytm-50x17.png" style="margin-left:3px; margin-top: -4px;" class="fl"/> </div>
