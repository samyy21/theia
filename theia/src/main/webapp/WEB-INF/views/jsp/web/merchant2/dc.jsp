	...
	<form autocomplete="off" name="creditcard-form" method="post" action="${pageContext.request.contextPath}/payment/request/submit?${queryStringForSession}" id="card" class="dc-form validated">
		...
		<ul class="grid">
        	<li class="mb20 card-wrapper">
				...
				<div class="error error2 promo-code-error <c:if test='${empty promoError && empty dcErrorInputClass}'>hide</c:if>">
            ...
            <li class="ml10 fr relative" id = "dcCvvWrapper">
                ...
                <div class="cvv-clue-box fl mt20 ml0 hide">
...
<%--         </c:if> --%>
        ...
        <div class="mt20">
        	<div class="btn-submit ${submitBtnClass} fl">
           		<input name="" type="submit" class="gry-btn fr" value="Pay now" id = "dcSubmit">
           	</div>
