<div class = 'card content ${6 eq paymentType ? "active" : ""}' id = "imps-card">
	<div class="card-header xsmall grey-text relative">
		<div class="fr">
		...
		<form autocomplete="off" class="imps-form validated" name="imps-form" method="post" action="${pageContext.request.contextPath}/payment/request/submit?${queryStringForSession}" id="card">
			...
			<ul class="grid imps-grid">
				<li>
					...
					<p>
						<input type="tel" class="text-input ${impsMobileErrorClass} required" name="mobileNo" size="19" maxlength="10" id="mobileNo"/>
					</p>
			...
			<div class="mt10">
				<div class="btn-submit ${submitBtnClass} fl">
	           		<input name="" type="submit" class="gry-btn" value="Pay now" id="impsSubmit">	          
	           	</div>
	...
	<ul class="grid imps-details">
		<li>
			<p class="">What is IMPS?</p>
	        <p class="mt10 small">
