<div class = 'card content ${15 eq paymentType ? "active" : ""}' id = "upi-card">
	<div class="card-header xsmall grey-text mb10 relative">
		
		<div class="clear"></div>
	</div>
	<form autocomplete="off" name="upi-form" method="post" action="${pageContext.request.contextPath}/payment/request/submit?${queryStringForSession}"  id="upi-form" class="upi-form validated">
