				...
				<div id = "nbWrapper">
					<select class="nbSelect" id = "nbSelect" data-size="5">
						...
						<c:forEach var="bank" items="${nbList}" begin="0">
						 ...
						 <c:set var="bankNM" value="${bank.bankName}" />
						 <%
...
// 						    String bNM = (String)pageContext.getAttribute("bankNM");
// 						    String bankName1 = null;
// 						    if(bNM!=null && bNM.trim().length()>0){
// 						    	bankName1 = "NB-" + bNM;	
// 						    }
						    
// 						    if(bankName1!=null && bankName1.trim().length()>0){
// 						    	 map = (java.util.Map<String, Object>)paymentCharges.get(bankName1);
