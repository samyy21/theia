...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<c:if test="${themeInfo.subTheme eq 'dishtv'}">
		...
		<c:choose>
	      <c:when test="${themeInfo.subTheme eq 'indiamart' || themeInfo.subTheme eq 'justeat'}">
		      <style>
				#login-box{display:none;}
				#paytm-wallet_tab{display:block;}
			  </style>
	      </c:when>
	      <c:otherwise>
      			<style>
					#login-box{display:block;}
					#paytm-wallet_tab{display:none;}
				</style>
	      </c:otherwise>
		</c:choose>
