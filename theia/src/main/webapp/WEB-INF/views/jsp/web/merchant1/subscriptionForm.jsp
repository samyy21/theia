...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body onload="backButtonOverride();">
		...
		<div id="wallet-details" data-available="${!walletInfo.walletFailed}" data-balance="${walletInfo.walletBalance}" data-wallet-only="${onlyWalletEnabled}"></div>
		...
		<div id="error-details" 
			...
			data-maintenancemsg="${entityInfo.maintainenceMessage}"
			data-lowerrormsg="${entityInfo.lowPercentageMessage}"
		></div>
		...
		<div class="container">
			...
			<div class="card summary-card">
				...
				<div id="merchant-logo" class="fl mt10 mr20 mb20">
					<img src="images/web/merchant/${merchInfo.merchantImage}" alt="" height="20"/>
				</div>
				</c:if>
			    ...
			    <div id="cart-details" class="fl">
					<div class="payment-details mb10 hide">
						...
						<c:if test="${txnInfo.subscriptionAmountType eq 'FIX' }">
						...
						<c:if test="${txnInfo.subscriptionAmountType ne 'FIX' }">
							<span class="show mt10">Amount to be debited per subscription : Rs ${txnInfo.txnAmount}</span>
						</c:if>
					</div>
