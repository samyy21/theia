		...
		<div class="container">
			...
			<div class="card summary-card">
				...
				<div id="merchant-logo" class="fl mt10 mr20 mb20">
					<img src="${ptm:stResPath()}images/web/merchant3/${merchInfo.merchantImage}" alt="" height="20"/>
				</div>
				</c:if>
			...
			<div class="subs-msgs <c:if test="${walletInfo.walletFailed}">hide</c:if>" >
				<h2 class="mt20 mb20">
					...
					<span class="subs-text subs-complete-payment medium hide">
						...
						<c:choose>
						      <c:when test="${themeInfo.subTheme eq 'airtel'}">
						      		Select an option to complete payment
						      </c:when>
						      <c:otherwise>
						      		Select an option to add <b class="b">Paytm</b> and complete <b class="b">Payment</b>.
						      </c:otherwise>
						</c:choose>
