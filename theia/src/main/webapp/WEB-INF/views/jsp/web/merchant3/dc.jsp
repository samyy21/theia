		...
		<ul class="grid">
        	<li class="mb20 card-wrapper">
				...
				<c:if test="${!empty txnInfo.promoCodeResponse && !empty txnInfo.promoCodeResponse.promoCodeDetail.promoCode}">
					...
					<div class="error error2 promo-code-error <c:if test='${empty promoError}'>hide</c:if>">
            ...
            <li class="ml10 fr relative" id = "dcCvvWrapper">
                ...
                <div class="cvv-clue-box hide">
	                <div class="dc-cvv-clue ui-cluetip mt10">
...
<%--         </c:if>   --%>
	...
	<c:if test="${themeInfo.subTheme eq 'bob'}">
   		<span class="mt10 b show" style="color:#fe5d27;">This transaction will be processed by<img src="images/web/merchant3/bob_logo.png" style="position: relative;top: 13px;display: inline;left: 10px;"></span>
   	</c:if>
</div>