		...
		<c:if test="${!empty atmList}">
			...
			<div class="mt10">
				<div class="btn-submit ${submitBtnClass} fl">
		           	<input name="submit-btn" type="submit" class="blue-btn required" value="Pay now" id="atmSubmit">
				</div>
				<a href="/theia/cancelTransaction?${queryStringForSession}" class="cancel">Cancel</a>
				<div class="clear"></div>
	        </div>
	        
	        <div id="atmWarningDiv" class="hide">
	        
				<div class="alert fl mt10">
					<div class="img img-alert fl mr10"></div>
					<span id="atmErrorMsg"  class="alert-msg"></span>
				</div>
			</div>
			<div class="clear"></div>
