	...
	<form autocomplete="off" class="rewards-form validated" name="rewards-form" method="post" action="${pageContext.request.contextPath}/payment/request/submit?${queryStringForSession}" id="card">
		...
		<ul class="grid">
        	...
        	<li>
            	...
            	<p class="cd">
					<input autocomplete="off" type="tel" name="" class="${rewardsCardErrorInputClass} rewardsCardNumber d text-input large-input cardInput" id="rewardsCardNo" type="text" size="19" maxlength="19" style="width: 278px">
        ...
        <div class="mt20">
			<div class="btn-submit ${submitBtnClass} fl">
           		<input name="" type="submit" class="gry-btn" value="Pay now" id = "rewardsOTPSubmit">	          
           	</div>
           	<a href="/theia/cancelTransaction?${queryStringForSession}" class="cancel">Cancel</a>
           	<div class="clear"></div>
        </div>
