...
<c:if test="${(5 ne paymentType || !empty ppi) && saveCardEnabled && themeInfo.subTheme ne 'ccdc'}">
	<a href="/theia/jsp/wap/merchantLow5_GA/${formName}.jsp?txn_Mode=SC${useWalletQuerystring}&${queryStringForSession}"
...
<c:if test="${(15 ne paymentType || !empty ppi) &&  upiEnabled && themeInfo.subTheme ne 'ccdc'}">
	<a href="/theia/jsp/wap/merchantLow5_GA/${formName}.jsp?txn_Mode=UPI${useWalletQuerystring}&${queryStringForSession}"
...
<c:if test="${(2 ne paymentType || !empty ppi) && dcEnabled}">
	<a href="/theia/jsp/wap/merchantLow5_GA/${formName}.jsp?txn_Mode=DC${useWalletQuerystring}&${queryStringForSession}"
...
<c:if test="${(1 ne paymentType || !empty ppi) && ccEnabled}">
	<a href="/theia/jsp/wap/merchantLow5_GA/${formName}.jsp?txn_Mode=CC${useWalletQuerystring}&${queryStringForSession}"
...
<c:if test="${(3 ne paymentType || !empty ppi) && netBankingEnabled && themeInfo.subTheme ne 'ccdc'}">
	<a href="/theia/jsp/wap/merchantLow5_GA/${formName}.jsp?txn_Mode=NB${useWalletQuerystring}&${queryStringForSession}"
...
<c:if test="${(13 ne paymentType || !empty wallet) && emiEnabled && themeInfo.subTheme ne 'ccdc'}">
	<a href="/theia/jsp/wap/merchantLow5_GA/${formName}.jsp?txn_Mode=EMI${useWalletQuerystring}&${queryStringForSession}"
...
<c:if test="${(12 ne paymentType || !empty wallet) && codEnabled && themeInfo.subTheme ne 'ccdc'}">
	<a href="/theia/jsp/wap/merchantLow5_GA/${formName}.jsp?txn_Mode=COD${useWalletQuerystring}&${queryStringForSession}"
		 data-txnmode="COD" onclick="pushGAData(this,'payment_mode_selected')"
	   id="COD-link class="pay-mode-link" <c:if test="${usePaytmCash && txnConfig.codHybridAllowed ne true}"> style="display:none;"</c:if>>
<span class="bottom-link">
...
<c:if test="${(8 ne paymentType || !empty ppi) && atmEnabled && themeInfo.subTheme ne 'ccdc'}">
	<a href="/theia/jsp/wap/merchantLow5_GA/${formName}.jsp?txn_Mode=ATM${useWalletQuerystring}&${queryStringForSession}"
...
<c:if test="${(6 ne paymentType ||  !empty ppi) && impsEnabled && themeInfo.subTheme ne 'ccdc'}">
	<a href="/theia/jsp/wap/merchantLow5_GA/${formName}.jsp?txn_Mode=IMPS${useWalletQuerystring}&${queryStringForSession}"
...
<c:if test="${(10 ne paymentType || !empty ppi) && cashcardEnabled && themeInfo.subTheme ne 'ccdc'}">
	<a href="/theia/jsp/wap/merchantLow5_GA/${formName}.jsp?txn_Mode=CASHCARD${useWalletQuerystring}&${queryStringForSession}"
...
<c:if test="${(11 ne paymentType || !empty wallet) && rewardsEnabled && themeInfo.subTheme ne 'ccdc'}">
	<a href="/theia/jsp/wap/merchantLow5_GA/${formName}.jsp?txn_Mode=REWARDS${useWalletQuerystring}&${queryStringForSession}"
