...
<div class="clear"></div>
    ...
    <p class="pt7">
    	<button type="submit" style="width:97%;margin-left:5px;border-radius: 5px;" data-txnmode="NB" onclick="pushGAData(this, 'pay_now_clicked')" class="clear gry-btn" disabled = "disabled" id="btnSubmit">Pay Now</button>
    </p>
 </c:if>
</div>
</form>
