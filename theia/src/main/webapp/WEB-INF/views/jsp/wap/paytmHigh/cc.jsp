<div data-role="collapsible" id="creditCard" class="ui-collapsible ui-collapsible-inset ui-collapsible-collapsed">
	...
	<div class="ui-collapsible-content ui-collapsible-content-collapsed">
		<form autocomplete="off" name="creditcard-form" method="post" action="/payment/request/submit" id="card" data-ajax="false">
			...
			<p id="cd">
				<div class="ui-input-text ui-shadow-inset ui-corner-all ui-btn-shadow ui-body-c">
	        		<input type="tel" id="cn" maxlength="16" data-type="cc" data-promocodes="${sessionScope.promoBinList}" class="cardInput ui-input-text ui-body-c" name="cardNumber" placeholder="Card Number"/>
	        	</div>
	        	...
	        	<div class="error clear promo-code-error" style="<c:if test='${empty promoError}'>display:none</c:if>">
	            ...
	            <c:if test="${'1' eq paymentType && !empty requestScope.validationErrors && !empty requestScope.validationErrors['INVALID_CARD']}">
					<div id="CCnoId" class="error clear" style="width: 150px;">${requestScope.validationErrors['INVALID_CARD']}</div>
					<script type="text/javascript">
						$(document).ready(function(){
							$("#cn").parent().css("border", "#b53b3b solid 1px");
						});
					</script>
				</c:if>
	        </p>
			...
			<ul class="ui-grid-b mt7 mb10">
	            <li class="ui-block-a mt7 expiry" id = "ccExpMonthWrapper">
	            	<div class="ui-select"><div data-corners="true" data-shadow="true" data-iconshadow="true" data-wrapperels="span" data-icon="dwn-arw" data-iconpos="right" data-theme="c" class="ui-btn ui-btn-up-c ui-shadow ui-btn-corner-all ui-btn-icon-right"><span class="ui-btn-inner"><span class="ui-btn-text"><span>MM</span></span><span class="ui-icon ui-icon-dwn-arw ui-icon-shadow">&nbsp;</span></span>
		                <select name="expiryMonth" id="ccMonth" data-icon="dwn-arw">
		            ...
		            <div class="ui-input-text ui-shadow-inset ui-corner-all ui-btn-shadow ui-body-c ui-disabled">
	              	...
	              	<c:if test="${'1' eq paymentType && !empty requestScope.validationErrors && !empty requestScope.validationErrors['INVALID_CARD_EXPIRY']}">
						<div id="ccexId" class="error clear" style="width: 150px;">${requestScope.validationErrors['INVALID_CARD_EXPIRY']}</div>
						<script type="text/javascript">
							$(document).ready(function(){
								$("#ccMonth").parent().css("border", "#b53b3b solid 1px");
								$("#ccYear").parent().css({"border":"#b53b3b solid 1px", "margin-bottom":"25px"});
							});
						</script>
					</c:if>
	          	</li>
		        
		        <li class="ui-block-b mt7 expiry" id = "ccExpYearWrapper">
		        	<div class="ui-select"><div data-corners="true" data-shadow="true" data-iconshadow="true" data-wrapperels="span" data-icon="dwn-arw" data-iconpos="right" data-theme="c" class="ui-btn ui-btn-up-c ui-shadow ui-btn-corner-all ui-btn-icon-right"><span class="ui-btn-inner"><span class="ui-btn-text"><span>YY</span></span><span class="ui-icon ui-icon-dwn-arw ui-icon-shadow">&nbsp;</span></span>  
		            	<select name="expiryYear" id="ccYear" data-icon="dwn-arw">
	            ...
	            <li class="ui-block-c mt4">
	            	<div class="ui-input-text ui-shadow-inset ui-corner-all ui-btn-shadow ui-body-c">
	            		<input name="cvvNumber" type="password" id="ccCvvBox" placeholder="CVV" value="" maxlength="4"  autocomplete="off" class="ui-input-text ui-body-c">
	            	</div>
	                <c:if test="${'1' eq paymentType && !empty requestScope.validationErrors && !empty requestScope.validationErrors['INVALID_CVV']}">
						<div id="CvvId" class="error clear" style="width: 150px;">${requestScope.validationErrors['INVALID_CVV']}</div>
						<script type="text/javascript">
							$(document).ready(function(){
								$("#ccCvvBox").parent().css("border", "#b53b3b solid 1px");
							});
						</script>
					</c:if>
	                
	                <div id="ccShowHideDiv" style="display:none;">
	                  <div class="cvv-icon"></div>
	                </div>
	                <div id="amexShowHideDiv" style="display:none;">
	                  <div class="ame-cvv-icon" alt="CVV" title="CVV"></div>
	                </div>
	            </li>
			</ul>
			<c:if test="${saveCardOption}">
		        <div id = "ccStoreCardWrapper" style="margin-left: 10px; margin-bottom: 10px; height:25px;">
			        <div class="checkbox" id="ccSaveCardLabel">
