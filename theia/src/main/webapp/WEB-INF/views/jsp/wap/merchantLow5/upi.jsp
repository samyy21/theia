...
<div class="clear"></div>
 ...
 <%--post convenince related --%>
    ...
    <c:if test ="${txnConfig != null &&  txnConfig.paymentCharges != null && txnConfig.paymentCharges.UPI != null &&  txnConfig.paymentCharges.UPI.totalConvenienceCharges ne '0.00'}">
    ...
    <!--Lock image-->
    <p class="pt7">
    	<button type="submit" class="blue-btn" id="btnSubmit" data-txnmode="BHIM_UPI" onclick="pushGAData(this, 'pay_now_clicked')" >Pay Now</button>
    </p>
