...
<c:if test ="${!loginInfo.loginFlag && merchInfo.mid ne 'scwpay09224240900570'}">
					...
					<div class="login-strip">
						...
						<div class="center inline-display left expSelect  ">
							<div class="fl inline-display wid16">
								<img src="${ptm:stResPath()}images/wap/merchantLow/wallet.png" class="fl pt3 wid70" alt="" title="">
							</div>
							<div class="fl inline-display wid80 login-content" style="position:relative;"><span style="width:70%;display:inline-block;">Login to use your Paytm balance</span>
	...
	<div class="notification alert loading blue-text mb10 " id="login-wait">
		<span class="">
