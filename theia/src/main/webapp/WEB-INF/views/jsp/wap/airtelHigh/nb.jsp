<div data-role="collapsible" id="netbanking" class="ui-collapsible ui-collapsible-inset ui-collapsible-collapsed">
	...
	<div class="ui-collapsible-content ui-collapsible-content-collapsed">
		...
		<form autocomplete="off" name="netbanking-form" method="post" action="submitTransaction" id="card" data-ajax="false">
			...
			$(document).ready(function(){
				...
				if(bankName.trim().length > 0) {
					...
					//	$('#nbSubmit').attr("disabled", "disabled");
						$('#warningDiv').show();
					//	$('#nbSubmit').removeClass('blue-btn');
					//	$('#nbSubmit').addClass('gry-btn');
