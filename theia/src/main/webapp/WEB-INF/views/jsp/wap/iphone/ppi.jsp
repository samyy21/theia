<%String contextPathPPI = com.paytm.pgplus.theia.utils.ConfigurationUtil.getProjectProperty("context.path"); %>
<div data-role="content" data-theme="i" id="ppi-container" <c:if test="${'7' ne paymentType}">style="display:none"</c:if>>
	...
	<section>
		<form autocomplete="off" name="ProcessPaymentRequest" method="post" action="<%=contextPathPPI %>/payment/request/submit" data-ajax="false">
