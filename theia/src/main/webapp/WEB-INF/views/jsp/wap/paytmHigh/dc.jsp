		...
		<form autocomplete="off" name="debitcard-form" method="post" action="/payment/request/submit" id="card" data-ajax="false">
			...
			<p id="cd">
				<div class="ui-input-text ui-shadow-inset ui-corner-all ui-btn-shadow ui-body-c">
	        		<input type="tel" id="cn1" data-type="dc" data-promocodes="${sessionScope.promoBinList}" maxlength="19" class="cardInput ui-input-text ui-body-c" name="cardNumber" placeholder="Card Number"/>
	        	</div>
