...
<%--TODO: save card compution need to check if separate param is needed like addSaveCardEnabled --%>
...
<%-- <div>
	<h2 class="mt10">
		<span class="addMoneyText large hide msg">
			<span>To complete payment, add to Paytm Wallet</span>
...
<div id="otherpaymentModeHeading" class="heading non-promocode-options bottom_border">Other payment modes</div>
<%-- other modes links --%>
