			...
			<form autocomplete="off" method="post" action="${pageContext.request.contextPath}/payment/request/submit?${queryStringForSession}" onsubmit = "return submitForm(this)" id="DC-form">
				...
				<div class="row-dot">
					<p class="error">
						...
						<input id="card-number" type="tel" maxlength="23" name="cardNumber" class="mt5 ${cssClass}" value="${!empty cardNumber ? cardNumber : defaultCardNumber}" onblur="onCardNumberBlur('dc')" onkeydown="pressCardSpace(event);" onkeyup="onCardDown(false)"/>
					...
					<p class="pt7 cvv" id ="normalOptionCVV">
						...
						<input type="tel" id="normalOptionCVVTxt" maxlength="4" size="5" name="cvvNumber" class ="mask cvv-input ${cssClass}" onkeyup="onKeypressCvvNumber(arguments[0])"/> <img src="${ptm:stResPath()}images/wap/paytmAppLow/cvv.png" alt="CVV" title="CVV" />
							${errorText}
					</p>
					...
					<div id="idebitPayOption" class="mt20 hide">
						...
						<p class="pt7 cvv hide" id ="idebitOptionCVV">
							...
							<input type="tel" id="idebitOptionCVVTxt" maxlength="4" size="5" name="cvvNumber" class ="mask cvv-input ${cssClass}" onkeyup="onKeypressCvvNumber(arguments[0])"/> <img src="${ptm:stResPath()}images/wap/paytmAppLow/cvv.png" alt="CVV" title="CVV" />
								${errorText}
						</p>
					</div>
						<%-- --         </c:if> -- --%>
