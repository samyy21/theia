...
<div class="row-dot">
	<p>
		...
		<input id="card-number" name="cardNumber" type="tel" maxlength="23" class="mt5 ${cssClass}" value="${!empty cardNumber ? cardNumber : defaultCardNumber}" onblur="onCardNumberBlur('cc')" onkeydown="pressCardSpace(event);" onkeyup="onCardDown(true)"/>
    ...
    <p class="pt7">
    	<div class="fl">
            ...
            <select name="expiryMonth" id="ccExpMnth" class="expSelect mt5 ${cssClass}">
        ...
        <div class="fl ml20">
            ...
            <select name="expiryYear" id="ccExpYr" class="expSelect mt5 ${cssClass}">
    ...
    <p class="pt7 cvv">
        ...
        <input id="ccCvvBox" type="tel" maxlength="4" size="5" name="cvvNumber" class ="mask cvv-input ${cssClass}" onkeyup="onKeypressCvvNumber(arguments[0])"/> <img src="${ptm:stResPath()}images/wap/merchantLow/security-code.png" alt="Security Code" title="Security Code" />
        ${errorText}
    </p>
    ...
    <p class="pt7 ">
    	<button type="submit" id="btnSubmit"  class="blue-btn cc-blue-btn">Pay Now</button>
    </p> 
