...
<%
    ...
    if(reqBankCode != null && reqBankCode.toString().trim().indexOf("other") > -1 && !"null".equalsIgnoreCase(reqBankCode)) {
        showOthers = true;
        bankCode = reqBankCode;
    }

    if((dbList == null || dbList.size() == 0) && (atmList == null || atmList.size() == 0) || "other".equals(reqBankCode)) {
        showOthers = true;
        selectOther = true;
        bankCode = "other";
    }
...
<div data-role="content" data-theme="i" id="debitcard-container"
     <c:if test="${'2' ne paymentType  && '8' ne paymentType}">style="display:none"</c:if>>
    <div class="errors">
        <ul id="errmsg">
    ...
    <section>
        <form autocomplete="off" method="post" action="payment/request/submit" data-ajax="false">
