...
<c:forEach var="sarvatraVpainfo"  items="${sarvatraVpainfo.sarvatraVpaMapInfo}" varStatus="myIndex">
  ...
  <div class="mb10 upiPushInput">
    ...
    <input type="checkbox" name="upiPush" value="${sarvatraVpainfo.key}" data-href="/theia/jsp/wap/merchantLow/${formName}.jsp?txn_Mode=UPI_PUSH&UPI_KEY=${sarvatraVpainfo.key}${useWalletQuerystring}&${queryStringForSession}" data-value='${sarvatraVpainfo.value}' onchange="upiPushCardSelect(this)" <c:if test="${upiPushcheckBoxSelected}">checked</c:if>  />
