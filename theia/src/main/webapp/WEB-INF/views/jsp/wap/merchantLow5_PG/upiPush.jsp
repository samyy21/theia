...
<script>
   ...
   if(paymentType== 18 && !getParameter('txn_Mode') && (getParameter('use_wallet') != 1 && ("${isPPBL_Enabled && (paymentBankInactive eq true)}" ==='true' && parseFloat(walletBalance) >= parseFloat("${txnInfo.txnAmount}"))  || parseFloat(walletBalance) < parseFloat("${txnInfo.txnAmount}")) && getParameter('use_paytmcc') !== "1"){
