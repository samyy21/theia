		...
		<form autocomplete="off" name="rewards-form" method="post" action="/payment/request/submit" id="rewards" data-ajax="false">
			...
			<p>
				...
				<div class="rewards-msg">
			 		Enter your registered mobile number to get One-time Password (OTP).
			 	</div>
			...
			<div class="load-btn">
	  			<button type="submit" class="submitButton" value="Check available points" data-icon="ldr" data-iconpos="right">Proceed Securely</button>
	  		</div>
			</div>
