...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		var paymentFormUrl = "/jsp/wap/merchantLow2/paymentForm.jsp";
		 ...
		 function showAllPaymentModes(){
			 location.href = "/theia/jsp/wap/merchantLow2/paymentForm.jsp?showAll=1";
			 return;
		 };
...
<body>
	...
	<%-- <c:set  var="loginUrl" value="${loginInfo.oAuthInfoHost}/oauth2/authorize?response_type=code&scope=paytm&theme=${loginInfo.loginTheme || 'pg')}&client_id=${loginInfo.oAuthInfoClientID}&redirect_uri=${loginInfo.oAuthInfoReturnURL}" ></c:set> --%>
	...
	<div>
		...
		<c:if test="${usePaytmCash && !isHybrid && !walletInfo.walletFailed}">
	...
	<div class="footer">
		<div id="partner-logos">
			...
			<!-- <img src="${ptm:stResPath()}images/wap/merchantLow2/partners.gif" alt="Norton Visa Mastercard PCI DSS" title="Norton Visa Mastercard PCI DSS" /> --> 
		</div>
	</div>
	<script type = "text/javascript">
		onPageLoad();
