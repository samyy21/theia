...
<div class="row-dot">
    ...
    <c:if test="${usePaytmCash && txnConfig.codHybridAllowed}">
    	<p class="small">
    		At the time of delivery, Rs <fmt:formatNumber value="${txnInfo.txnAmount - walletInfo.walletBalance}" maxFractionDigits="2" minFractionDigits="2" /> will have to be given to the courier boy.
    	</p>
    ...
    <c:if test="${!usePaytmCash}">
    	...
    	<p class="small">
    	<p class="pt7">
    		<button type="submit" class="blue-btn">Complete Order</button>
    	</p> 
