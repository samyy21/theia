...
<form autocomplete="off" method="post" action="/payment/request/submit" onsubmit = "submitForm()">
    ...
    <p class="pt7">
        ...
        <div class="small mt5">Enter valid registered mobile number to get One-time Password (OTP).</div>
		${errorText}
    </p>
