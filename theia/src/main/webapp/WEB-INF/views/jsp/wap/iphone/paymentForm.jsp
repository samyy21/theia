...
<!-- <base href="/oltp-web/" /> -->
	<%String contextPath = com.paytm.pgplus.theia.utils.ConfigurationUtil.getProjectProperty("context.path"); %>
	<link href="<%=contextPath %>/css/wap/iphone/mobile.css" rel="stylesheet" type="text/css" />
	<script src="<%=contextPath %>/js/radio.js" type="text/javascript"></script>
	<script src="<%=contextPath %>/js/jquery.js"></script>
	<script src="<%=contextPath %>/js/jquery.mobile-1.2.0.min.js"></script>
	<script src="<%=contextPath %>/js/wap/iphone/touchslider.js"></script>
	<script type="text/javascript" src="<%=contextPath %>/js/wap/iphone/functions.js"></script>
...
<c:if test="${txnInfo == null}">
	...
	<div data-role="page" data-theme="i"> 
		<div data-role="header" class="header" role="banner" data-fullscreen="true" id="headerDiv">
			<span class="ml5">Payment Mode</span>
			<a href="<%=contextPath %>/cancelTransaction" data-role="button" data-icon="custom-back-icon" data-ajax="false"></a> 
  		</div>
