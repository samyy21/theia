...
<div class="row-dot">
	<p class="error">
    	...
    	<input id="card-number" type="tel" maxlength="19" name="cardNumber" class="mt5 ${cssClass}" onblur="onCardNumberBlur('dc')"/>
    	${errorText}
    ...
    <p class="pt7 cvv">
        ...
        <input type="password" maxlength="4" size="5" name="cvvNumber" class = "${cssClass}" onkeypress="onKeypressCvvNumber(arguments[0])"/> <img src="/images/wap/paytmAppLow/cvv.png" alt="CVV" title="CVV" />
        ${errorText}
    </p>
     <p class="small mb10">
