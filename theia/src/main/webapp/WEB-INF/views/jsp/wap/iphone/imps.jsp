<%String contextPathIMPS = com.paytm.pgplus.theia.utils.ConfigurationUtil.getProjectProperty("context.path"); %>
<div data-role="content" data-theme="i" id="imps-container" <c:if test="${'6' ne paymentType}">style="display:none"</c:if>>
	...
	<section>
		<form autocomplete="off" name="ProcessPaymentRequest" method="post" action="<%=contextPathIMPS %>/payment/request/submit" data-ajax="false">
