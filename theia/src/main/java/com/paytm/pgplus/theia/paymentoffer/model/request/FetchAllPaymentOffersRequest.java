...
public class FetchAllPaymentOffersRequest implements Serializable {
    ...
    @Valid
    @NotNull
    private FetchAllPaymentOffersRequestBody body;
    ...
    public FetchAllPaymentOffersRequestBody getBody() {
        return body;
    }

    public void setBody(FetchAllPaymentOffersRequestBody body) {
        this.body = body;
    }
